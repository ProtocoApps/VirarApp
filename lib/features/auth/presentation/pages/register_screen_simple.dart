...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  UserProfileType? _selectedProfileType;
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Icon(
              icon,
              color: isSelected ? AppColors.gold : AppColors.gold.withOpacity(0.7),
              size: 24,
            ),
            ...
            Text(
              title,
              style: TextStyle(
                color: isSelected ? AppColors.gold : AppColors.softWhite,
                fontSize: 14,
                fontWeight: FontWeight.w600,
                fontFamily: 'Poppins',
              ),
  ...
  void _handleRegister() async {
    ...
    if (success) {
      // Save profile type for future use
      await ProfileService().saveProfileType(_selectedProfileType!);
      
      // Navigate based on profile type
      if (mounted) {
        if (_selectedProfileType == UserProfileType.citizen) {
